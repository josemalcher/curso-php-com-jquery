...
<div id="container">
    ...
    <button class="btn" id="btn_mostrar_esconder">Mostrar/Esconder</button>
    <button class="btn" id="btn_slide_up">Slide Up</button>
    <button class="btn" id="btn_slide_down">Slide Down</button>
